...
<main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Editar Registro de Defuncion <i class="fa-solid fa-book-skull"></i></h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Editar Datos del registro de Defuncion</h5>


              <form action="{{route('defunciones.update',$item->id_fallecido)}}" method = "POST">
                @csrf
                @method("PUT")
              <fieldset class="mb-4">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control"  name = "nombre_fallecido" id="nombre_fallecido"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select" id="sexo"  name ="sexo" value="{{$item->sexo}}">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="entidad_nacimiento_" id="entidad_nacimiento_" value="{{ isset($item_entidades) ? $item_entidades->entidad_nacimiento_ : '' }}" >
                    </div>
                      <div class="row">
                          <div class="col-md-6 mb-3">
                              <label for="CURP" class="form-label">5.CURP</label>
                              <input type="text" class="form-control" id="CURP"  name ="CURP" value="{{$item->CURP}}">
                          </div>
            ...
            <fieldset class="mb-4">
              ...
              <div class="row">
                  <div class="col-md-4 mb-3">
                      ...
                      <select class="form-select" id="afromexicano"  name = "afromexicano" value="{{$item->afromexicano}}">
                  ...
                  <div class="col-md-4 mb-3">
                      ...
                      <select class="form-select" id="indigena"  name = "indigena" value="{{$item->indigena}}">
                          <option value="1">Sí</option>
                          <option value="0">No</option>
                          <option value="3">Se ignora</option>
                      </select>
                  ...
                  <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select" id="lengua_indigena"  name ="lengua_indigena" value="{{$item->lengua_indigena}}">
                        <option value="1">Sí</option>
          ...
          <div class="col-md-4 mb-3">
            ...
            <select class="form-select" id="nacionalidad"   name="nacionalidad" value="{{$item->nacionalidad}}">
        ...
        <fieldset class="mb-4">
            ...
            <div class="row">
                ...
                <div class="col-md-8 mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <input type="number" class="form-control" id="minutos" placeholder="Minutos"  name="minutos" value="{{$item->minutos}}">
                        </div>
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3 mt-2">
                            <input type="number" class="form-control" id="años_cumplidos" placeholder="Años"  name="años_cumplidos" value="{{$item->años_cumplidos}}">
                        </div>
                        <div class="col-md-3 mt-2">
          ...
          <fieldset class="mb-4">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <select class="form-select" id="situacion_conyugal"  name = "situacion_conyugal" value="{{$item->situacion_conyugal}}">
        ...
        <div class="row">
           <!-- <div class="col-md-4 mb-3">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="calle"  name="calle" value="{{$item->calle}}">
            </div>
            <div class="col-md-4 mb-3">
                <label for="numero_ext" class="form-label">Número Exterior</label>
                <input type="text" class="form-control" id="numero_ext"  name="numero_ext" value="{{$item->numero_ext}}">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 mb-3">
                <label for="numero_int" class="form-label">Número Interior</label>
                <input type="text" class="form-control" id="numero_int"  name="numero_int" value="{{$item->numero_int}}">
            </div>
            <div class="col-md-4 mb-3">
                <label for="tipo_asentamiento_humano" class="form-label">Tipo de Asentamiento Humano</label>
                <input type="text" class="form-control" id="tipo_asentamiento_humano"  name="tipo_asentamiento_humano" value="{{$item->tipo_asentamiento_humano}}">
            </div>
            <div class="col-md-4 mb-3">
                <label for="nombre_asentamiento_humano" class="form-label">Nombre del Asentamiento Humano</label>
                <input type="text" class="form-control" id="nombre_asentamiento_humano"  name="nombre_asentamiento_humano" value="{{$item->nombre_asentamiento_humano}}">
            </div>
        </div>
        <div class="row">
            <div class="col-md-4 mb-3">
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="localidad"  name="localidad" value="{{$item->localidad}}">
            </div>
            <div class="col-md-4 mb-3">
                <label for="municipio" class="form-label">Municipio o Alcaldía</label>
                <input type="text" class="form-control" id="municipio"  name="municipio" value="{{$item->municipio}}">
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 mb-3">
                <label for="pais" class="form-label">Entidad Federativa o País</label>
                <input type="text" class="form-control" id="pais"  name="pais" value="{{$item->pais}}">
            </div>
        </div>
    </fieldset>
        ...
        <hr>
          ...
          <div class="row">
              <div class="col-md-6 mb-3">
                  ...
                  <select class="form-select" id="escolaridad"  name = "escolaridad" value="{{$item->escolaridad}}">
              ...
              <div class="col-md-6 mb-3">
                  ...
                  <select class="form-select" id="escolaridad_completa"  name="escolaridad_completa" value="{{$item->escolaridad_completa}}">
      ...
      <fieldset class="mb-4">
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="ocupacion_habitual"  name="ocupacion_habitual" value="{{$item->ocupacion_habitual}}">
            </div>
            <div class="col-md-6 mb-3">
                <label for="trabajador" class="form-label">¿Trabaja?</label>
                <select class="form-select" id="trabajador"  name="trabajador" value="{{$item->trabajador}}">
                    <option value="1">Sí</option>
                    <option value="0">No</option>
                </select>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 mb-3">
                ...
                <select class="form-select" id="afiliacion_servicios_salud"  name ="afiliacion_servicios_salud" value="{{$item->afiliacion_servicios_salud}}">
                    <option value="ninguna">Ninguna</option>
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="text" class="form-control" id="numero_afiliacion_social"  name="numero_afiliacion_social" value="{{$item->numero_afiliacion_social}}">
            </div>
        </div>
    </fieldset>
    <!--=======================================DATOS EL INFORMANTE=========================================== -->
    <fieldset class="mb-4">
        ...
        <div class="row"> <!-- hace que se alinien horizontalmente los elementos -->
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="nombre_informante"  name="nombre_informante"value="{{$item->nombre_informante}}">
            </div>
            <div class="col-md-4 mb-3">
                <label for="primer_apellido_informante" class="form-label">Primer Apellido</label>
                <input type="text" class="form-control" id="primer_apellido_informante" name="primer_apellido_informante"value="{{$item->primer_apellido_informante}}">
            </div>
            <div class="col-md-4 mb-3">
                <label for="segundo_apellido_informante" class="form-label">Segundo Apellido</label>
                <input type="text" class="form-control" id="segundo_apellido_informante"  name="segundo_apellido_informante" value="{{$item->segundo_apellido_informante}}">
            </div>
        </div>
        </div>
        <div class="col-md-4 mb-3">
        <label for="parentesco_con_fallecido" class="form-label">17.Parentesco con la(el) fallecida/o</label>
        <input type="text" class="form-control" id="parentesco_con_fallecido"  name="parentesco_con_fallecido"  value="{{$item->parentesco_con_fallecido}}">
        </div>

        <div class="col-md-4 mb-3">
            <label for="firma_informante" class="form-label">18.Firma de la (del) informante (nombre)</label>
            <input type="text" class="form-control" id="firma_informante"  name="firma_informante" value="{{$item->firma_informante}}">
        </div>

        <div class="col-md-4 mb-3">
            <label for="sitio_defuncion" class="form-label">19. Sitio donde sucedio la defuncion</label>
            <select class="form-select" id="sitio_defuncion"  name ="sitio_defuncion" value="{{$item->sitio_defuncion}}">
        ...
        <div class="col-md-4 mb-3">
            ...
            <input type="text" class="form-control" id="nombre_unidad_medica"  name="nombre_unidad_medica" value="{{$item->nombre_unidad_medica}}">
        </div>
        <div class="col-md-5 mb-3">
            <label for="clave_establecimientos_salud" class="form-label">19.2 Clave Única de Establecimientos de Salud (CLUES)</label>
            <input type="text" class="form-control" id="clave_establecimientos_salud"  name="clave_establecimientos_salud" value="{{$item->clave_establecimientos_salud}}">
        </div>
        </div>
    </fieldset>
    ...
    <fieldset class="mb-4">
        ...
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="text" class="form-control" id="tipo_vialidad_lugar_defuncion"  name="tipo_vialidad_lugar_defuncion" value="{{$item->tipo_vialidad_lugar_defuncion}}">
            </div>
            <div class="col-md-5 mb-3">
                <label for="nombre_vialidad_lugar_defuncion" class="form-label">20.2 Nombre de la vidalidad</label>
                <input type="text" class="form-control" id="nombre_vialidad_lugar_defuncion"  name="nombre_vialidad_lugar_defuncion" value="{{$item->nombre_vialidad_lugar_defuncion}}">
            </div>
            <div class="col-md-5 mb-3">
                <label for="num_exterior_lugar_defuncion" class="form-label">20.3 Número Exterior</label>
                <input type="number" class="form-control" id="num_exterior_lugar_defuncion"  name="num_exterior_lugar_defuncion" value="{{$item->num_exterior_lugar_defuncion}}">
            </div>
            <div class="col-md-5 mb-3">
                <label for="num_interior_lugar_defuncion" class="form-label">20.2 Número Interior</label>
                <input type="number" class="form-control" id="num_interior_lugar_defuncion"  name="num_interior_lugar_defuncion" value="{{$item->num_interior_lugar_defuncion}}">
            </div>
            <div class="col-md-5 mb-3">
                <label for="asentamiento_humano_lugar_defuncion" class="form-label">20.5 Tipo de Asentamiento Humano</label>
                <input type="text" class="form-control" id="asentamiento_humano_lugar_defuncion"  name="asentamiento_humano_lugar_defuncion" value="{{$item->asentamiento_humano_lugar_defuncion}}">
            </div>
            <div class="col-md-5 mb-3">
                <label for="nombre_asentamiento_lugar_defuncion" class="form-label">20.6 Nombre Asentamiento Humano </label>
                <input type="text" class="form-control" id="nombre_asentamiento_lugar_defuncion"  name="nombre_asentamiento_lugar_defuncion" value="{{$item->nombre_asentamiento_lugar_defuncion}}">
            </div>
            <div class="col-md-5 mb-3">
                <label for="codigoPostal_lugar_defuncion" class="form-label">20.7 Código Postal</label>
                <input type="text" class="form-control" id="codigoPostal_lugar_defuncion"  name="codigoPostal_lugar_defuncion" value="{{$item->codigoPostal_lugar_defuncion}}">
            </div>
            <div class="col-md-5 mb-3">
                <label for="lugar_defuncion_localidad" class="form-label">20.8 Localidad</label>
                <input type="text" class="form-control" id="lugar_defuncion_localidad"  name="lugar_defuncion_localidad" value="{{$item->lugar_defuncion_localidad}}">
            </div>
            <div class="col-md-5 mb-3">
                <label for="lugar_defuncion_municipio" class="form-label">20.9 Municipio o Alcaldía</label>
                <input type="text" class="form-control" id="lugar_defuncion_municipio"  name="lugar_defuncion_municipio" value="{{$item->lugar_defuncion_municipio}}">
            </div>
            <div class="col-md-5 mb-3">
                <label for="entidadFederativa_lugar_defuncion" class="form-label">20.10 Entidad Federativa</label>
                <input type="text" class="form-control" id="entidadFederativa_lugar_defuncion"  name="entidadFederativa_lugar_defuncion" value="{{$item->entidadFederativa_lugar_defuncion}}">
            </div>
        </div>
    ...
    <fieldset class="mb-4">
        <div class="row">
            <div class="col-md-4 mb-3">
                ...
                <input type="date" class="form-control" id="fecha_defuncion"  name="fecha_defuncion" value="{{$item->fecha_defuncion}}">
                <input type="time" class="form-control" id="hora_defuncion"  name="hora_defuncion" step="1" value="{{$item->hora_defuncion}}">
            </div>
            <div class="col-md-4 mb-3">
                ...
                <select class="form-select" id="atencionMedica_antes_fallecer"  name ="atencionMedica_antes_fallecer" value="{{$item->atencionMedica_antes_fallecer}}">
            ...
            <div class="col-md-4 mb-3">
                ...
                <select class="form-select" id="cirugia_reciente"  name ="cirugia_reciente" value="{{$item->cirugia_reciente}}">
                    <option value="SI">Si</option>
                    <option value="NO">No</option>
                    <option value="SE_IGNORA">Se ignora</option>
                </select>
            ...
            <div class="col-md-4 mb-3">
                ...
                <input type="date" class="form-control" id="fecha_cirugia"  name="fecha_cirugia" value="{{$item->fecha_cirugia}}">
            </div>
            <div class="col-md-4 mb-3">
                <label for="motivo_cirugia" class="form-label">23.2 Motivo de cirugía</label>
                <input type="text" class="form-control" id="motivo_cirugia"  name="motivo_cirugia" value="{{$item->motivo_cirugia}}">
            </div>
            <div class="col-md-4 mb-3">
                <label for="defuncion_violenta" class="form-label">24. ¿Fue Defuncion Accidental o Violenta? </label>
                <select class="form-select" id="defuncion_violenta"  name ="defuncion_violenta" value="{{$item->defuncion_violenta}}">
                    <option value="SI">Si</option>
                    <option value="NO">No</option>
                    <option value="SE_IGNORA">Se ignora</option>
                </select>
            ...
            <div class="col-md-4 mb-3">
                ...
                <select class="form-select"  id="tipo_defuncion"  name="tipo_defuncion" value="{{$item->tipo_defuncion}}">
    ...
    <fieldset class="mb-4">
        ...
        <div class="card-body">
            <div class="mb-3">
                ...
                <div class="row mb-2">
                    <div class="col-md-8">
                        <input type="text" class="form-control" name="causa_a"  value="{{$item->causa_a}}" placeholder="a) Enfermedad o condición que causó directamente la defunción">
                    </div>
                    <div class="col-md-4">
                        <input type="text" class="form-control" name="intervalo_a" value="{{$item->intervalo_a}}" placeholder="Intervalo aproximado">
                    </div>
                </div>
                <div class="mb-3">
                    <label class="form-label"> </label>
                    <textarea class="form-control" name="otras_condiciones" value="{{$item->otras_condiciones}}" rows="3" 
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" name="otras_condiciones" value="{{$item->otras_condiciones}}" rows="3"></textarea>
            </div>
            
            <div class="row">
                <div class="col-md-6 mb-3">
                    <label class="form-label">Código CIE</label>
                    <input type="text" class="form-control" name="codigo_cie" value="{{$item->codigo_cie}}">
                </div>
            </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select" id="necropsia"  name="necropsia" value="{{$item->necropsia}}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select" id="hallazgos_necropsia" name="hallazgos_necropsia" value="{{$item->hallazgos_necropsia}}">
                        <option value="SI">Sí</option>
                        <option value="NO">No</option>
                    </select>
                </div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select" id="muerte_embarazo" name="muerte_embarazo" value="{{$item->muerte_embarazo}}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select" id="causas_embarazo" name="causas_embarazo" value="{{$item->causas_embarazo}}">
                        <option value="SI">Sí</option>
                        <option value="NO">No</option>
                        <option value="SE_IGNORA">Se ignora</option>
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select" id="complicaciones_embarazo" name="complicaciones_embarazo" value="{{$item->complicaciones_embarazo}}">
                        <option value="SI">Sí</option>
                        <option value="NO">No</option>
                    </select>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select" id="muerte_encefalica" name="muerte_encefalica" value="{{$item->muerte_encefalica}}">
                        <option value="SI">Sí</option>
                        <option value="NO">No</option>
                    </select>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select" id="donacion_organos" name="donacion_organos" value="{{$item->donacion_organos}}">
                        <option value="SI">Sí</option>
                        <option value="NO">No</option>
                        <option value="SE_IGNORA">Se ignora</option>
                    </select>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="causa_basica" name="causa_basica" value="{{$item->causa_basica}}">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="codigo_adicional" class="form-label">30.1 Código adicional</label>
                    <input type="text" class="form-control" id="codigo_adicional" name="codigo_adicional" value="{{$item->codigo_adicional}}">
                </div>
    
                <div class="col-md-4 mb-3">
                    <label for="desempeno_trabajo" class="form-label">31. ¿Ocurrió en el desempeño de su trabajo?</label>
                    <select class="form-select" id="desempeno_trabajo" name="desempeno_trabajo" value="{{$item->desempeno_trabajo}}">
                        <option value="SI">Sí</option>
                        <option value="NO">No</option>
                        <option value="SE_IGNORA">Se ignora</option>
                    </select>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <select class="form-select" id="lugar_lesion" name="lugar_lesion" value="{{$item->lugar_lesion}}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="acta_ministerio" name="acta_ministerio" value="{{$item->acta_ministerio}}">
                </div>

                <div class="col-md-4 mb-3">
                    <label for="relacion_agresor" class="form-label">34. Relación del presunto agresor con la(o) fallecida(o)</label>
                    <input type="text" class="form-control" id="relacion_agresor" name="relacion_agresor" value="{{$item->relacion_agresor}}">
                </div>
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="descripcion_lesion" name="descripcion_lesion" value="{{$item->descripcion_lesion}}">
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="tipo_vialidad_donde_ocurrio" name="tipo_vialidad_donde_ocurrio" value="{{$item->tipo_vialidad_donde_ocurrio}}">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="nombre_vialidad" class="form-label">36.2 Nombre de la vialidad</label>
                    <input type="text" class="form-control" id="nombre_vialidad" name="nombre_vialidad" value="{{$item->nombre_vialidad}}">
                </div>
                
                <div class="col-md-2 mb-3">
                    <label for="num_ext" class="form-label">36.3 Núm. Ext.</label>
                    <input type="text" class="form-control" id="num_ext" name="num_ext" value="{{$item->num_ext}}">
                </div>
                
                <div class="col-md-2 mb-3">
                    <label for="num_int" class="form-label">36.4 Núm. Int.</label>
                    <input type="text" class="form-control" id="num_int" name="num_int" value="{{$item->num_int}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="tipo_asentamiento" class="form-label">36.5 Tipo de asentamiento humano</label>
                    <input type="text" class="form-control" id="tipo_asentamiento" name="tipo_asentamiento" value="{{$item->tipo_asentamiento}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="nombre_asentamiento" class="form-label">36.6 Nombre del asentamiento humano</label>
                    <input type="text" class="form-control" id="nombre_asentamiento" name="nombre_asentamiento" value="{{$item->nombre_asentamiento}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="ocurrio_lesion_codigo_postal" class="form-label">36.7 Código Postal</label>
                    <input type="text" class="form-control" id="ocurrio_lesion_codigo_postal" name="ocurrio_lesion_codigo_postal" value="{{$item->ocurrio_lesion_codigo_postal}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="ocurrio_lesion_localidad" class="form-label">36.8 Localidad</label>
                    <input type="text" class="form-control" id="ocurrio_lesion_localidad" name="ocurrio_lesion_localidad" value="{{$item->ocurrio_lesion_localidad}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="ocurrio_lesion_municipio" class="form-label">36.9 Municipio o Alcaldía</label>
                    <input type="text" class="form-control" id="ocurrio_lesion_municipio" name="ocurrio_lesion_municipio" value="{{$item->ocurrio_lesion_municipio}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="entidad_federativa" class="form-label">36.10 Entidad federativa</label>
                    <input type="text" class="form-control" id="entidad_federativa" name="entidad_federativa" value="{{$item->entidad_federativa}}">
                </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <select  class="form-select" name="certificada_por" id="certificada_por" value="{{$item->certificada_por}}">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="otro_certificada_por" name="otro_certificada_por" value="{{$item->otro_certificada_por}}">
                </div>
            </div>
            <hr>
        </div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="nombre_certificante" name="nombre_certificante" value="{{$item->nombre_certificante}}">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="apellidoPaterno_certificante">Primer Apellido</label>
                    <input type="text" class="form-control" id="apellidoPaterno_certificante" name="apellidoPaterno_certificante" value="{{$item->apellidoPaterno_certificante}}">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="apellidoMaterno_certificante">Segundo Apellido</label>
                    <input type="text" class="form-control" id="apellidoMaterno_certificante" name="apellidoMaterno_certificante" value="{{$item->apellidoMaterno_certificante}}">
                </div>

                <div class="col-md-4 mb-3">
                    <label for="certificante_sies_medico">39. Si la (el) Certificante es Médica/o</label>
                    <input type="text" class="form-control" id="certificante_sies_medico" name="certificante_sies_medico" value="{{$item->certificante_sies_medico}}">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="firma_certificante">40. Firma de la (del) Certificante (nombre)</label>
                    <input type="text" class="form-control" id="firma_certificante" name="firma_certificante" value="{{$item->firma_certificante}}">
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="tipo_vialidad_41" name="tipo_vialidad_41" value="{{$item->tipo_vialidad_41}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="nombre_vialidad_41" class="form-label">41.2 Nombre de la vialidad</label>
                    <input type="text" class="form-control" id="nombre_vialidad_41" name="nombre_vialidad_41" value="{{$item->nombre_vialidad_41}}">
                </div>
                
                <div class="col-md-2 mb-3">
                    <label for="num_ext_41" class="form-label">41.3 Núm. Ext.</label>
                    <input type="text" class="form-control" id="num_ext_41" name="num_ext_41" value="{{$item->num_ext_41}}">
                </div>
                
                <div class="col-md-2 mb-3">
                    <label for="num_int_41" class="form-label">41.4 Núm. Int.</label>
                    <input type="text" class="form-control" id="num_int_41" name="num_int_41" value="{{$item->num_int_41}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="tipo_asentamiento_41" class="form-label">41.5 Tipo de asentamiento humano</label>
                    <input type="text" class="form-control" id="tipo_asentamiento_41" name="tipo_asentamiento_41" value="{{$item->tipo_asentamiento_41}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="nombre_asentamiento_41" class="form-label">41.6 Nombre del asentamiento humano</label>
                    <input type="text" class="form-control" id="nombre_asentamiento_41" name="nombre_asentamiento_41" value="{{$item->nombre_asentamiento_41}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="certificante_codigo_postal" class="form-label">41.7 Código Postal</label>
                    <input type="text" class="form-control" id="certificante_codigo_postal" name="certificante_codigo_postal" value="{{$item->certificante_codigo_postal}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="certificante_localidad" class="form-label">41.8 Localidad</label>
                    <input type="text" class="form-control" id="certificante_localidad" name="certificante_localidad" value="{{$item->certificante_localidad}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="certificante_municipio" class="form-label">41.9 Municipio o Alcaldía</label>
                    <input type="text" class="form-control" id="certificante_municipio" name="certificante_municipio" value="{{$item->certificante_municipio}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="entidad_federativa_41" class="form-label">41.10 Entidad federativa</label>
                    <input type="text" class="form-control" id="entidad_federativa_41" name="entidad_federativa_41" value="{{$item->entidad_federativa_41}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="telefono_41" class="form-label">41.11 Teléfono</label>
                    <input type="tel" class="form-control" id="telefono_41" name="telefono_41" value="{{$item->telefono_41}}">
                </div>
                <hr>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" class="form-control" id="fecha_certificacion" name="fecha_certificacion" value="{{$item->fecha_certificacion}}">
                </div>
                <hr>
            </div>
        </div>
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="numero_registro" name="numero_registro" value="{{$item->numero_registro}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="numero_libro" class="form-label">Núm. Libro</label>
                    <input type="text" class="form-control" id="numero_libro" name="numero_libro" value="{{$item->numero_libro}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="numero_acta" class="form-label">Núm. Acta</label>
                    <input type="text" class="form-control" id="numero_acta" name="numero_acta" value="{{$item->numero_acta}}">
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="registro_localidad" name="registro_localidad" value="{{$item->registro_localidad}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="registro_municipio" class="form-label">44.2 Municipio o Alcaldía</label>
                    <input type="text" class="form-control" id="registro_municipio" name="registro_municipio" value="{{$item->registro_municipio}}">
                </div>
                
                <div class="col-md-4 mb-3">
                    <label for="entidad_registro" class="form-label">44.3 Entidad federativa</label>
                    <input type="text" class="form-control" id="entidad_registro" name="entidad_registro" value="{{$item->entidad_registro}}">
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <input type="date" class="form-control" id="fecha_de_registro" name="fecha_de_registro" value="{{$item->fecha_de_registro}}">
                </div>
